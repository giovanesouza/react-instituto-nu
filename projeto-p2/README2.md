...
>> Componentes novos: PinService.js

## getFolders (chamando direto no useEffect)
## AddFolder
## AddPinInFolder

> No diretório **src** cria pasta **services** com o component **pinService.js**
...
//  salva pin
 savePinInFolder("955e-184ab", "pin123"); // parÂmetros = folderId, pinId
